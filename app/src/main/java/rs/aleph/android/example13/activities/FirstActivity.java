...
public class FirstActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 	{
        ...
        // Loads URLs from array resource
        final String[] urls = getResources().getStringArray(R.array.urls);

        // Creates an ArrayAdaptar from the array of String
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this, R.layout.list_item, urls);
        ListView listView = (ListView) findViewById(R.id.listofURLs);
